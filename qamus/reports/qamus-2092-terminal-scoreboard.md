...
| audit terminal state | n (live 78.78%) |
|---|---:|
| `needs_hover_authoring` (≥1 pending token in its āyāt) | **1,861** |
| `needs_source_photo_review` (āyāt hover-complete; source verification outstanding) | **214** |
| `needs_quran_ref_verification` (bad/range refs) | **10** |
| `deferred_missing_source` (no addressable āyāt) | **7** |
| **total / unknown** | **2,092 / 0** |

By Fusha index class (per-entry matrices `qamus/reports/{nouns,verbs}/`): **nouns 1,022 @ 80.29%**,
**verbs 970 @ 78.51%**, **particles 100** (PP1). N1/V1 +55 (+689 occ); B2 +159 (+1,571); B3 +186 (+1,013);
**B4 +181 (+732) → 78.78%**. As entries become hover-complete they advance `needs_hover_authoring` →
