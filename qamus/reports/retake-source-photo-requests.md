...
If a specific entry ever fails visual verification against its existing page, the exact request would
name: `source_key`, book-entry-number, page image (`pgNNN.jpeg` / intake path), and the crop region.
