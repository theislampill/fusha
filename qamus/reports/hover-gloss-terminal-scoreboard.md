...
| state | count | pct |
|---|---|---|
| **resolved** | 43,589 | 87.35% |
| **pending (exact blocker)** | 6,311 | 12.65% |
| **total** | 49,900 | 100% |
...
|---|---|---|
| `stem_base_unknown` | 4,156 | author the host stem/lexeme in Qamus, then re-run the resolver |
| `source_entry_unverified` | 1,775 | add the inflected form to the entry forms[] (or verify the entry from source photo) and re-run |
