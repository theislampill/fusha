...
| 5 | host-only hover on a token with attached `بِـ`/`لِـ`/`كَـ`/suffix pronoun | accepted the host before segmenting visible pieces | [`drills/hover-composition-and-routing.md`](drills/hover-composition-and-routing.md) · [`../sarf/drills/clitic-and-host-morphology.md`](../sarf/drills/clitic-and-host-morphology.md) · [`../sarf/procedures/clitic-and-host-morphology.md`](../sarf/procedures/clitic-and-host-morphology.md) |
| 5–8 | cannot produce a parse key or display classes for a composed token | composition stayed informal instead of becoming renderable metadata | [`qamus-hover-parse-key-and-color.md`](qamus-hover-parse-key-and-color.md) · [`drills/parse-key-and-color-layer.md`](drills/parse-key-and-color-layer.md) · [`../qamus/reports/morphosyntax-token-contract.md`](../qamus/reports/morphosyntax-token-contract.md) |
...
| 7 | `و`/`ف` read as one fixed connector | function split not routed | [`../nahw/drills/grammar-routing-hard-cases.md`](../nahw/drills/grammar-routing-hard-cases.md) · [`../nahw/procedures/function-token-hover-review.md`](../nahw/procedures/function-token-hover-review.md) |
...
| 9 | treated a concept-map class as the hover meaning | semantic metadata was mistaken for translation authority | [`../qamus/procedures/grammar-resource-usage.md`](../qamus/procedures/grammar-resource-usage.md) · [`../tools/qac_concept_map_adapter.py`](../tools/qac_concept_map_adapter.py) |
...
| 10 | missed a conditional, hāl, purpose accusative, vocative, or exception frame | clause role was flattened into a word gloss | [`../nahw/drills/grammar-routing-hard-cases.md`](../nahw/drills/grammar-routing-hard-cases.md) · [`../nahw/procedures/exception-and-vocative-review.md`](../nahw/procedures/exception-and-vocative-review.md) |
